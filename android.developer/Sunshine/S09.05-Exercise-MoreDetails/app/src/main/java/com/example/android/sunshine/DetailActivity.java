...
public class DetailActivity extends AppCompatActivity
    ...
    private static final int ID_DETAIL_LOADER = 1000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHighTempTextView = findViewById(R.id.high_temp_text_view);
        mLowTempTextView = findViewById(R.id.low_temp_text_view);
        mHumidityTextView = findViewById(R.id.humidity_temp_text_view);
        mPressureTextView = findViewById(R.id.pressure_temp_text_view);
        mWindTextView = findViewById(R.id.wind_temp_text_view);
