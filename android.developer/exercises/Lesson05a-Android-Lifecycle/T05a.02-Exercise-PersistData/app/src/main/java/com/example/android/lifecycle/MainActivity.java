...
public class MainActivity extends AppCompatActivity {
    ...
    private final static String LIFECYCLE_CALLBACKS_TEXT_KEY = "lifecycle_callbacks_text";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)) {
            String textToDisplay = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
            mLifecycleDisplay.setText(textToDisplay);
        }
