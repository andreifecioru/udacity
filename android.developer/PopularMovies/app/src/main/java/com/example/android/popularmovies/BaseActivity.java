...
import com.example.android.popularmovies.utils.NetworkUtils.ConnectivityStatus;
...
public abstract class BaseActivity extends AppCompatActivity {
    ...
    private void showBackOnlineStatus() {
        ...
        mConnStatusTextView.setBackgroundColor(getResources().getColor(R.color.green));
    ...
    private void showOfflineStatus() {
        ...
        mConnStatusTextView.setBackgroundColor(getResources().getColor(R.color.black));
